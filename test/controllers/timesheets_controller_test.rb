...
class TimesheetsControllerTest < ActionController::TestCase
  ...
  test "should create timesheet" do
    assert_difference('Timesheet.count') do
      post :create, timesheet: { employee_id: @timesheet.employee_id, hours_spent: @timesheet.hours_spent, log_date: @timesheet.log_date }
    end
  ...
  test "should update timesheet" do
    patch :update, id: @timesheet, timesheet: { employee_id: @timesheet.employee_id, hours_spent: @timesheet.hours_spent, log_date: @timesheet.log_date }
    assert_redirected_to timesheet_path(assigns(:timesheet))
  end
